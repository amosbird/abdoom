;;; private/amos/autoload/evilified.el -*- lexical-binding: t; -*-
...
(bind-map evilified-default-map
  :evil-keys ("SPC")
  :evil-states (evilified)
  :override-minor-modes t
  :override-mode-name evilified-leader-override-mode)
