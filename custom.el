...
%i" :prepend t :empty-lines-before 1 :empty-lines-after 1)
 ...
 '(safe-local-variable-values
   '((cc-links . " -lpthread -ldl ")
     (cc-flags . " -Og -std=c++17 -fopenmp -I/usr/local/include ")
     (cc-flags . " -O1 -std=c++17 -fopenmp -I/usr/local/include ")
     (cc-flags . " -O2 -std=c++17 -fopenmp -I/usr/local/include ")
     (cc-flags . " -O3 -std=c++17 -fopenmp -I/usr/local/include ")
     (cc-flags . " -O0 -std=c++17 -fopenmp -I/usr/local/include ")
     (cc-exec . "clang++")
     (cc-links . " -lpthread -lzvbi -lzstd -ldl ")
     (cc-flags . " -std=c++17 -fopenmp -I/usr/local/include ")
     (cc-exec . "g++")
     (cc-dbg . "g++ -g -O0")
